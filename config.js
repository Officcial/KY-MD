...
global.email = "officialky680@yahool.com";
global.location = "Lahore,Nigeria,United Kingdom.";
global.mongodb = process.env.MONGODB_URI || "";
global.allowJids = process.env.ALLOW_JID || "null";
global.blockJids = process.env.BLOCK_JID || "null";
global.DATABASE_URL = process.env.DATABASE_URL || "";
global.timezone = process.env.TZ || process.env.TIME_ZONE || "Africa/Lagos";
global.github = process.env.GITHUB || "https://github.com/Officcial/KY-MD";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "𝐅𝐈𝐋𝐄-𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄𝐃-𝐁𝐘-OFFICIAL-𝐌𝐃😍",
  ...
  antilink_values: process.env.ANTILINK_VALUES || "chat.whatsapp.com,all",
